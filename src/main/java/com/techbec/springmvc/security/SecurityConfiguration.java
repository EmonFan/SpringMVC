package com.techbec.springmvc.security;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
                .antMatchers("/home","/inputs","/feeds", "/visualize-*").permitAll()
		...
		http.headers().frameOptions().sameOrigin(); //Fix X-Frame options. Spring security module DENYs by default
	}
